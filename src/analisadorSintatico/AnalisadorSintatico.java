...
import nucleo.Entidade;
import nucleo.Interface;
import nucleo.Metodo;
import nucleo.Parametro;
...
public class AnalisadorSintatico{
    ...
    public AnalisadorSintatico(List<String> lexemas){

        fita = new ArrayList<String>(lexemas);
        
        comando(fita);
    }
    
    private void comando(List<String> fita){
        ...
        if(!fita.isEmpty()){
            ...
            while(!fita.isEmpty() && !fita.get(0).equals("{")){
                ...
                switch(al){ 
                    ...
                    break;
                    case "implements":
                        entidade.setNomesInterfacesImp(interfacesClasse());
                    break;
                    default:
                        entidade.setNome(al);
                    break;    
    ...
    private List<String> interfacesClasse(){
